...
WHERE maNV = 'NV003'
select top(1) sum([CT_HoaDon].soLuong), SanPham.maSP
				from SanPham inner join [CT_HoaDon] on SanPham.maSP = [CT_HoaDon].maSP inner join HoaDon on HoaDOn.maHD = [CT_HoaDon].maHD
				where HoaDon.ngayLapHoaDon between  '2023-01-01' and '2023-05-27' group by SanPham.maSP
-- Insert into HoaDon table
INSERT INTO HoaDon
VALUES 
('HD021','NV001','KH001','2023-04-03',200000),
('HD022','NV002','KH002','2023-04-04',300000),
('HD023','NV003','KH003','2023-04-05',400000),
('HD024','NV001','KH004','2023-04-06',500000),
('HD025','NV002','KH005','2023-04-07',600000),
('HD026','NV003','KH006','2023-04-08',700000),
('HD027','NV001','KH007','2023-04-09',800000),
('HD028','NV002','KH008','2023-04-10',900000),
('HD029','NV003','KH009','2023-04-11',1000000),
('HD030','NV001','KH010','2023-04-12',1100000),
('HD031','NV002','KH011','2023-04-13',1200000),
('HD032','NV003','KH012','2023-04-14',1300000),
('HD033','NV001','KH013','2023-04-15',1400000),
('HD034','NV002','KH014','2023-04-16',1500000),
('HD035','NV003','KH015','2023-04-17',1600000),
('HD036','NV001','KH016','2023-04-18',1700000),
('HD037','NV002','KH017','2023-04-19',1800000),
('HD038','NV003','KH018','2023-04-20',1900000),
('HD039','NV001','KH019','2023-04-21',2000000),
('HD040','NV002','KH020','2023-04-22',2100000),
('HD041','NV003','KH021','2023-04-23',2200000),
('HD042','NV001','KH022','2023-04-24',2300000),
('HD043','NV002','KH023','2023-04-25',2400000),
('HD044','NV003','KH024','2023-04-26',2500000),
('HD045','NV001','KH025','2023-04-27',2600000),
('HD046','NV002','KH026','2023-04-28',2700000),
('HD047','NV003','KH027','2023-04-29',2800000),
('HD048','NV001','KH028','2023-04-30',2900000),
('HD049','NV002','KH029','2023-05-01',3000000),
('HD050','NV003','KH030','2023-05-02',3100000);

-- Insert into CT_HoaDon table
