...
public class Frm_TrangChuNhanVien extends javax.swing.JFrame {
	...
	private JPanel pnl_QLNV = new Pnl_QuanLyNhanVien();
        ...
        private JPanel pnl_ThongKe = new Pnl_ThongKeNhanVien();
        ...
        menu.addEvent(new MenuEvent(){
            ...
            public void selected(int index, int subIndex, boolean menuItem){
                if(menuItem) {
                    ...
                    else if(selectedMenuItem.equals("Thống kê")) {
                        pnl_center.removeAll();
                        pnl_center.add(pnl_ThongKe, BorderLayout.CENTER);
                        pnl_center.revalidate();
                        pnl_center.repaint(); 
                    }
                }
